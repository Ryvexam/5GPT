...
import { ArrowLeft, BookOpen, ShieldCheck, Code2, Search, FileText, ListTodo } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900">Documentation Technique</h1>
                <p className="text-sm text-slate-500">Méthodologie & Choix Architecturaux</p>
              </div>
            </div>
          </div>
        </div>
